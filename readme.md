...
<h4>Plugins</h4>
Each of the elements displayed in the overlay are generated by a plugin. A plugin consists, at less, on two files: 
- plugin.py     - Contains the properties and methods of the plugin.
- <a href="https://github.com/pinakure/yt-obs/blob/main/ramon/plugins/example.html">template.html</a> - Contains the frontend structure for the plugin. 

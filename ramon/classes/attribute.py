...
class Attribute:
    ...
    def setup( groupname, group, types, name, sizes, heights, italics, bolds, shadows, posxs, posys, blurs,  bcolors, bwidths, sposxs, sposys ):
        Attribute.name          = name
    ...
    def integer( x, y, name, value, parent=None):
        D.add_slider_int(
            tag             = f'plugin-setting-{Attribute.plugin}-{name}',
            default_value   = value, 
            callback        = Plugin.updateSettings, 

...
Fly.prototype.drawToTemperatureMap = function(){
	// Mantain warm map
	VPU.wset(this.position.x+1	, this.position.y+1	);
	VPU.wset(this.position.x	, this.position.y+1	);
	VPU.wset(this.position.x+1	, this.position.y	);
	VPU.wset(this.position.x+2	, this.position.y+1	);
	VPU.wset(this.position.x+1	, this.position.y+2	);
}
